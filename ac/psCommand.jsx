/*
Photoshop Export script to be used with Autoconnect's importer.
 */
...
/**
 * Creates a ui palette with a list of predefined arnold attribute names.
...
function CreateUI(Object) {
  ATTRIBUTE_TYPES = [{
    ...
    {
      attribute: 'directDiffuse',
      type: 'float1',
      name: 'Direct Diffuse Weight'
    },
    {
      attribute: 'indirectDiffuse',
      type: 'float1',
